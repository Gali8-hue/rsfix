                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item"><a href="tambah_dokter.php" class="sidebar-link"><span
                                            class="hide-menu"> Tambah Daftar Dokter
                                        </span></a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="data_ruangan.php" class="sidebar-link"><span
                                            class="hide-menu"> Data Ruangan/Bangsal
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="tambah_ruangan.php" class="sidebar-link"><span
                                            class="hide-menu"> Tambah Data Ruangan/Bangsal
                                        </span></a>
                                </li>
                            </ul>
                        </li>
